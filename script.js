...
const questions = [
  {
    prompt: "老师突然说这周要加一次随堂测，你第一反应更像哪种？",
    options: [
      {
        title: "先把范围和重点圈出来，别自己吓自己",
        text: "我会先把最该补的那部分抓出来，尽量把局面拉回可控状态。",
        values: { reaction: 34, structure: 92, expression: 20, judgment: 72 },
        devices: { resistor: 3, opamp: 1 }
      },
      {
        title: "嘴上说着完了，身体先进入放空模式",
        text: "我不太会立刻动起来，通常会先慌一阵，再慢慢把自己拽回来。",
        values: { reaction: 18, structure: 42, expression: 56, judgment: 28 },
        devices: { capacitor: 3, inductor: 1 }
      },
      {
        title: "先找题狠狠干，靠手感把魂叫回来",
        text: "我更容易靠立刻开做把自己拉进状态，细节可以边做边补。",
  ...
  {
    prompt: "一个知识点你已经卡了很久，你更像会怎么处理？",
    options: [
      {
        title: "回到最基础的地方，一点点重新拆",
        text: "我宁愿慢一点，也想把底层逻辑补齐，不太愿意糊里糊涂过关。",
        values: { reaction: 30, structure: 96, expression: 22, judgment: 70 },
        devices: { resistor: 2, opamp: 2 }
      },
      {
        title: "先丢一边，等脑子自己哪天突然想通",
        text: "我硬磕久了会越来越烦，通常会先撤，过阵子再回来碰碰运气。",
        values: { reaction: 14, structure: 50, expression: 68, judgment: 34 },
        devices: { capacitor: 2, inductor: 2 }
      },
      {
        title: "直接去找懂的人问，先打通再说",
        text: "我不太介意绕过中间步骤，只要能先通，我就会马上去问。",
  ...
  {
    prompt: "假期原本想早起做事，结果睁眼已经中午了，你更像哪种反应？",
    options: [
      {
        title: "先止损，把今天还能救的部分救回来",
        text: "我会快速重排一下今天剩下的时间，尽量别让整天彻底报废。",
        values: { reaction: 46, structure: 88, expression: 24, judgment: 68 },
        devices: { resistor: 3, opamp: 1 }
      },
      {
        title: "先自责五分钟，然后顺理成章继续躺着",
        text: "我有时会进入一种“都这样了那就算了”的模式，节奏很难马上捡回来。",
        values: { reaction: 12, structure: 30, expression: 44, judgment: 20 },
        devices: { capacitor: 2, inductor: 2 }
      },
      {
        title: "立刻切成补救模式，硬把进度追回来",
        text: "这种情况反而容易激起我的狠劲，我会很想从现在开始狠狠干。",
  ...
  {
    prompt: "你正烦着，室友又开始外放视频，你大概率会？",
    options: [
      {
        title: "先忍一下，等我没那么炸了再说",
        text: "我不太想当场爆炸，更可能先把自己压住，再找机会讲清楚。",
        values: { reaction: 22, structure: 76, expression: 30, judgment: 54 },
        devices: { resistor: 2, capacitor: 2 }
      },
      {
        title: "直接让他关掉，别在这时候碰我雷区",
        text: "我如果已经烦了，通常会非常直接，不想让问题继续拖着。",
        values: { reaction: 82, structure: 70, expression: 40, judgment: 96 },
        devices: { diode: 3, resistor: 1 }
      },
      {
        title: "不一定正面说，但气氛会立刻变得很明显",
        text: "我可能不会直接开怼，但会让对方明显感觉到我已经不爽了。",
  ...
  {
    prompt: "大家开会越聊越散的时候，你通常会变成哪种人？",
    options: [
      {
        title: "把大家往回拽，先让这事有主线",
        text: "我会开始替大家收口，不然继续聊下去只会越来越散。",
        values: { reaction: 44, structure: 94, expression: 18, judgment: 76 },
        devices: { resistor: 3, opamp: 1 }
      },
      {
        title: "先让每个人都把想说的说完",
        text: "我更像一个缓冲层，想先知道大家到底在纠结什么，再去整理。",
        values: { reaction: 24, structure: 40, expression: 64, judgment: 22 },
        devices: { capacitor: 3, opamp: 1 }
      },
      {
        title: "抓一个最能成的点，先把人带着往前走",
        text: "我很容易在这种时候先选一条路，边做边修，总比原地打转强。",
  ...
  {
    prompt: "你和朋友因为一件小事有点别扭，你更像哪种？",
    options: [
      {
        title: "想找个时机说开，不想一直别着",
        text: "我不喜欢关系长期悬着，会想办法让事情回到一个能继续相处的状态。",
  ...
  {
    prompt: "喜欢的人回你消息忽快忽慢，你一般会怎么想？",
    options: [
      {
        title: "先观察一阵，别因为几条消息就上头",
        text: "我会先看看对方整体状态和节奏，不想因为一两次回复就把自己搞乱。",
        values: { reaction: 20, structure: 54, expression: 60, judgment: 30 },
        devices: { capacitor: 3, opamp: 1 }
      },
      {
        title: "如果我觉得不对劲，会想早点问清楚",
        text: "我不太喜欢暧昧不清，宁愿早点知道到底值不值得继续投入。",
        values: { reaction: 84, structure: 72, expression: 42, judgment: 96 },
        devices: { diode: 3, resistor: 1 }
      },
      {
        title: "嘴上说无所谓，心里已经演完一整部剧",
        text: "我很容易被一点点信号带着走，情绪起伏通常会比较明显。",
  ...
  {
    prompt: "如果你决定表白或摊牌，你更像下面哪种节奏？",
    options: [
      {
        title: "先把时机、氛围、对方状态都看一遍",
        text: "我会做很多心理建设，希望尽量把翻车概率降到最低。",
        values: { reaction: 26, structure: 90, expression: 28, judgment: 74 },
        devices: { resistor: 2, opamp: 2 }
      },
      {
        title: "会憋很久，憋到快把自己憋坏才说",
        text: "我不容易轻易开口，但一旦到临界点，就会一下子全说出来。",
        values: { reaction: 18, structure: 46, expression: 82, judgment: 40 },
        devices: { capacitor: 3, inductor: 1 }
      },
      {
        title: "感觉差不多了就冲，不想一直猜",
        text: "我更愿意直接给自己一个答案，哪怕结果不完美，也比一直悬着强。",
  ...
  {
    prompt: "做小组作业时，队友迟迟不交东西，你更可能怎么做？",
    options: [
      {
        title: "先把框架和截止时间重新立住",
        text: "我会主动把要求再说清楚，让大家知道继续拖会出什么问题。",
        values: { reaction: 50, structure: 94, expression: 30, judgment: 78 },
        devices: { resistor: 3, opamp: 1 }
      },
      {
        title: "先自己补一部分，别让全组一起死",
        text: "我不太想当场撕破脸，通常会先接住烂摊子，再看后面怎么办。",
        values: { reaction: 24, structure: 48, expression: 66, judgment: 24 },
        devices: { capacitor: 3, resistor: 1 }
      },
      {
        title: "直接点名催，实在不行就把人换掉",
        text: "我对这种拖全组后腿的情况忍耐度不高，通常会很快做取舍。",
  ...
  {
    prompt: "当你特别忙、消息又特别多的时候，你往往会变成哪种状态？",
    options: [
      {
        title: "先分类处理，别让消息把我淹了",
        text: "我会尽量给事情排优先级，不让自己被信息洪水直接冲走。",
        values: { reaction: 56, structure: 92, expression: 24, judgment: 82 },
        devices: { opamp: 3, resistor: 1 }
      },
      {
        title: "脑子会先卡住，然后谁都不想理",
        text: "信息一多我就容易短暂掉线，需要一点缓冲时间才能重新接上。",
        values: { reaction: 14, structure: 36, expression: 50, judgment: 18 },
        devices: { capacitor: 2, inductor: 2 }
      },
      {
        title: "会先砍掉一堆不重要的，只保主线",
        text: "我能很快切出主次，但也可能因为太快而显得有点冷。",
  ...
  {
    prompt: "吵架的时候，你最容易出现哪种模式？",
    options: [
      {
        title: "努力把情绪按住，想把问题说清楚",
        text: "哪怕我已经不爽了，也会尽量让谈话留在能解决问题的轨道上。",
  ...
  {
    prompt: "如果考试考砸了，你最像下面哪种后续反应？",
    options: [
      {
        title: "先找出到底错在哪，下次别再栽一次",
        text: "我更在意定位问题，想知道到底是方法错了还是节奏错了。",
        values: { reaction: 48, structure: 94, expression: 22, judgment: 88 },
        devices: { opamp: 3, resistor: 1 }
      },
      {
        title: "先emo一下，短期内不太想看那科",
        text: "我需要先恢复心情，不然再碰那科只会更烦更抗拒。",
        values: { reaction: 12, structure: 34, expression: 52, judgment: 20 },
        devices: { capacitor: 2, inductor: 2 }
      },
      {
        title: "会立刻找题再刷，想马上把场子找回来",
  ...
  {
    prompt: "如果让熟人偷偷评价你的一个“毛病”，更可能是哪句？",
    options: [
      {
        title: "“你有时候太稳了，稳到有点慢。”",
      ...
      {
        title: "“你很会憋，很多情绪都要攒很久才说。”",
        text: "我不太习惯即时表达，很多感受会先存在心里，拖久了才释放出来。",
